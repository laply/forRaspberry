...
pm1p0_grimm = np.uint16(value_buffer[7] << 8 + value_buffer[8])
pm2p5_grimm = np.uint16(value_buffer[9] << 8 + value_buffer[10])
pm10_grimm = np.uint16(value_buffer[11] << 8 + value_buffer[12])
